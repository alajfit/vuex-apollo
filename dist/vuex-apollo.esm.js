...
module.exports={name:"vuex-apollo",version:"1.2.0",description:"Vuex Setup with Apollo Integration",main:"dist/vuex-apollo.umd.js",module:"dist/vuex-apollo.esm.js",unpkg:"dist/vuex-apollo.min.js",scripts:{"build:browser":"parcel build src/index.js --out-dir dist --out-file vuex-apollo.min.js --target browser","build:es":"parcel build src/index.js --out-dir dist --out-file vuex-apollo.esm.js --target electron","build:umd":"parcel build src/index.js --out-dir dist --out-file vuex-apollo.umd.js --target node",build:"npm run build:browser && npm run build:es && npm run build:umd","docs:dev":"vuepress dev docs","docs:build":"vuepress build docs",demo:"parcel tests/demo/index.html --out-dir tests/demo/dist",release:"release-it"},repository:{type:"git",url:"git+https://github.com/alajfit/vuex-apollo.git"},keywords:["vuex","apollo","graphql"],author:"Alan J. Fitzpatrick <alajfit@gmail.com>",license:"ISC",bugs:{url:"https://github.com/alajfit/vuex-apollo/issues"},homepage:"https://github.com/alajfit/vuex-apollo#readme",devDependencies:{"@vue/component-compiler-utils":"^2.1.0","babel-plugin-transform-object-rest-spread":"^6.26.0","babel-plugin-transform-runtime":"^6.23.0","babel-preset-env":"^1.7.0","babel-preset-es2015":"^6.24.1","node-sass":"^4.9.1",parcel:"^1.9.4","parcel-bundler":"^1.9.4","parcel-plugin-vue":"^1.5.0","release-it":"^7.4.7",vue:"^2.5.16",vuepress:"^0.10.2"},dependencies:{"apollo-boost":"^0.1.10",graphql:"^0.13.2","graphql-tag":"^2.9.2",vuex:"^3.0.1"}};
